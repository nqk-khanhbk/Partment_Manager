...
import com.example.department_manager.dto.response.InvoiceApartmentResponse;
import com.example.department_manager.entity.InvoiceApartment;
...
public interface InvoiceApartmentRepository extends JpaRepository<InvoiceApartment, Long>, JpaSpecificationExecutor<InvoiceApartment> {
    @Query("SELECT new com.example.department_manager.dto.response.InvoiceApartmentResponse(ia.invoice.id, ia.invoice.name, ia.invoice.description, ia.invoice.updatedAt, ia.invoice.createdAt, ia.paymentStatus, null) " +
